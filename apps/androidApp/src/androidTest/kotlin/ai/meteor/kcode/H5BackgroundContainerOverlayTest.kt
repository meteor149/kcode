...
class H5BackgroundContainerOverlayTest {
    @Test
    fun dragsRestoresAndClosesBackgroundContainerFromFloatingWindow() {
        ...
        ActivityScenario.launch(MainActivity::class.java).use {
            runBlocking { controller.launch(H5PreviewRequest("/workspace/floating-preview/index.html", title)) }
            ...
            waitForAnyDescription(device, "Show background H5 apps", "查看后台 H5 应用").click()
