...
class AndroidAgentFileToolsTest {
    ...
    fun shellToolOnlySelectsExecutionIdentityAndDelegatesPermissionToGlobalGate() = runBlocking {
        var selectedMode: ai.meteor.kcode.settings.ShellExecutionMode? = null
        val tool = AndroidShellTool(
            modeProvider = { ai.meteor.kcode.settings.ShellExecutionMode.Adb },
        ...
        assertEquals(ai.meteor.kcode.settings.ShellExecutionMode.Adb, selectedMode)
