...
object UiText {
    ...
    val UnpinConversation = LocalizedText(Res.string.unpin_conversation_en, Res.string.unpin_conversation_zh)
    ...
    val Export = LocalizedText(Res.string.export_en, Res.string.export_zh)
    val More = LocalizedText(Res.string.more_en, Res.string.more_zh)
    ...
    val SubAgent = LocalizedText(Res.string.subagent_en, Res.string.subagent_zh)
    ...
    val GoalPauseAction = LocalizedText(Res.string.goal_pause_action_en, Res.string.goal_pause_action_zh)
    val GoalResumeAction = LocalizedText(Res.string.goal_resume_action_en, Res.string.goal_resume_action_zh)
    val GoalCancelAction = LocalizedText(Res.string.goal_cancel_action_en, Res.string.goal_cancel_action_zh)
    ...
    val ArtifactLibrary = LocalizedText(Res.string.artifact_library_en, Res.string.artifact_library_zh)
    val ArtifactCount = LocalizedText(Res.string.artifact_count_en, Res.string.artifact_count_zh)
    val EmptyArtifacts = LocalizedText(Res.string.empty_artifacts_en, Res.string.empty_artifacts_zh)
    val ArtifactLoadFailed = LocalizedText(Res.string.artifact_load_failed_en, Res.string.artifact_load_failed_zh)
    val RefreshArtifacts = LocalizedText(Res.string.refresh_artifacts_en, Res.string.refresh_artifacts_zh)
    val OpenArtifact = LocalizedText(Res.string.open_artifact_en, Res.string.open_artifact_zh)
    val WebAppArtifact = LocalizedText(Res.string.web_app_artifact_en, Res.string.web_app_artifact_zh)
